      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse" role="navigation">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="./changename.jsp">修改姓名</a></li>
...
<div id="content">
	  <div class="container">
	    <form action="ChangeNameServlet" method="post" onsubmit="return changepw(this);" class="form-horizontal">
	      <div class="row">
	        <h1 style="text-align:center; height:60px">修改姓名</h1>
	      </div>
	      <div class="col-md-6 col-md-offset-3 col-xs-10 col-xs-offset-1 register">

	            <div class="form-group">
	              <label for="name" class="col-sm-3 control-label">新姓名：</label>
	              <div class="col-sm-8">
	                <div class="input-group">
	                <input type="name" class="form-control" name="name" placeholder="请输入新姓名">
	    ...
	    <div class="row">
	        ...
	        <div class="col-md-3 col-xs-12">
	            <button type="submit" class="btn btn-info btn-block" onclick="if(!confirm('确定修改姓名？'))return false;"><b>&nbsp;&nbsp; 提交 &nbsp;&nbsp;</b>
